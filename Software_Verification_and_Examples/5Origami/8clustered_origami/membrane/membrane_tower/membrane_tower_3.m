...
grid on;
%% plot hinge moment
tenseg_plot_result(downsample(out_tspan,30), [downsample(sigma_l_t([1],:),30);downsample(sigma_l_t([2],:),30);downsample(sigma_l_t([3],:),30)],{'膜1-σx','膜1-σy','膜1-τxy'},{'Time (s)','sigma (pa)'},'plot_hinge_moment.png',saveimg);
